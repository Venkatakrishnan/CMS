...
const config = {
 user: process.env.NODE_ORACLEDB_USER || 'scott',
  ...
  poolMax: process.env.NODE_ORACLEDB_POOLMAX || 10,
  poolMin: process.env.NODE_ORACLEDB_POOLMIN || 2,
  poolIncrement: process.env.NODE_ORACLEDB_POOLINCREMENT || 4,
  poolTimeout: process.env.NODE_ORACLEDB_POOLTIMEOUT || 4
}
